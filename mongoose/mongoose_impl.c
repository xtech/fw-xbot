...
struct attribute s_imu_attributes[] = {
  {"gz", "double", NULL, offsetof(struct imu, gz), 0, false},
  {"gy", "double", NULL, offsetof(struct imu, gy), 0, false},
  {"gx", "double", NULL, offsetof(struct imu, gx), 0, false},
  {"az", "double", NULL, offsetof(struct imu, az), 0, false},
  {"ay", "double", NULL, offsetof(struct imu, ay), 0, false},
  {"ax", "double", NULL, offsetof(struct imu, ax), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_power_service_settings_attributes[] = {
  {"critical_volts", "double", NULL, offsetof(struct power_service_settings, critical_volts), 0, false},
  {"empty_volts", "double", NULL, offsetof(struct power_service_settings, empty_volts), 0, false},
  {"full_volts", "double", NULL, offsetof(struct power_service_settings, full_volts), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_state_attributes[] = {
  {"ros_online", "bool", NULL, offsetof(struct state, ros_online), 0, false},
  {"adapter_current", "double", NULL, offsetof(struct state, adapter_current), 0, false},
  {"charger_state", "string", NULL, offsetof(struct state, charger_state), 20, false},
  {"adapter_volts", "double", NULL, offsetof(struct state, adapter_volts), 0, false},
  {"battery_current", "double", NULL, offsetof(struct state, battery_current), 0, false},
  {"battery_volts", "double", NULL, offsetof(struct state, battery_volts), 0, false},
  {"battery_level", "int", NULL, offsetof(struct state, battery_level), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};

struct apihandler_data s_apihandler_imu = {{"imu", "data", true, 0, 0, 0UL}, s_imu_attributes, sizeof(struct imu), (void (*)(void *)) glue_get_imu, NULL};
struct apihandler_data s_apihandler_power_service_settings = {{"power_service_settings", "data", false, 0, 0, 0UL}, s_power_service_settings_attributes, sizeof(struct power_service_settings), (void (*)(void *)) glue_get_power_service_settings, (void (*)(void *)) glue_set_power_service_settings};
...
static struct apihandler *s_apihandlers[] = {
  (struct apihandler *) &s_apihandler_imu,
  (struct apihandler *) &s_apihandler_power_service_settings,
